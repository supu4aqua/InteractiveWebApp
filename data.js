const DATA = [{ //Question Answer 1
        question: 'Which of the following is true about fruits and vegetable processing?',
        answers: [
    ...
    { //Question Answer 2
        question: 'Statement 1: Coconuts and certain citrus fruits can be easily handled and shipped.Statement 2: Post harvest loss is non-existent.',
        answers: [
            'True, False',
            'True, True',
            'False, False',
    ...
    { //Question Answer 4
        question: 'Following are ways in which losses take place. Which of the following is untrue?',
        answers: [
            'Mechanical abrasion',
    ...
    { //Question Answer 5
        question: 'Statement 1: Primary processing such as trimming, sorting, cleaning can be done to add value to products.Statement 2: Secondary processing such as converting raw materials to products such as jellies, marmalade etc.',
        answers: [
            'True, False',
            'True, True',
            'False, False',
